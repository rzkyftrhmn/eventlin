...
<div class="form-group">
    <label class="form-label">Jenis Acara :</label>
    <select class="form-control form-select select2" name="is_berbayar" id="is_berbayar" required>
...
<div id="berbayar_fields" style="display: none; margin-top: 10px;">
    <div class="form-group">
        ...
        <input class="form-control" type="number" name="harga_tiket" value="{{ old('harga_tiket', $proposal->harga_tiket ?? '') }}" required>
    </div>
    <div class="form-group">
        <label class="form-label">Nama Bank :</label>
        <input class="form-control" type="text" name="nama_bank" value="{{ old('nama_bank', $proposal->nama_bank ?? '') }}" required>
    </div>
    <div class="form-group">
        <label class="form-label">Nomor Rekening :</label>
        <input class="form-control" type="text" name="nomor_rekening" value="{{ old('nomor_rekening', $proposal->nomor_rekening ?? '') }}" required>
    </div>
    <div class="form-group">
        <label class="form-label">Nama Pemilik Rekening :</label>
        <input class="form-control" type="text" name="nama_pemilik_rekening" value="{{ old('nama_pemilik_rekening', $proposal->nama_pemilik_rekening ?? '') }}" required>
    </div>
</div>
