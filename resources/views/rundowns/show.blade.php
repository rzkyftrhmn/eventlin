...
@section('content')
    ...
    @if(auth()->guard('admin')->check())
        <a href="{{ route('proposals.show', $id_proposal) }}">Kembali ke Detail Proposal</a><br>
        <a href="{{ route('rundowns.export.pdf', $rundown->id_rundown) }}" target="_blank">🖨 Export PDF</a>
    @elseif(auth()->guard('panitia')->check())
        ...
        @endif
        <br>
         <a href="{{ route('rundowns.panitia.export.pdf', $rundown->id_rundown) }}" target="_blank">🖨 Export PDF</a>
    @endif
    ...
    <table border="1" cellpadding="8" cellspacing="0" style="width: 100%; margin-top: 15px;">
        ...
        <tbody>
            ...
            <form method="GET" style="margin-bottom: 15px;">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari kegiatan atau detail...">
